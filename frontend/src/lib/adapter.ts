...
export function adaptBackendStation(raw: any, activeAnomalyIds: string[] = []): Station {
  ...
  return {
    ...
    latitude: typeof raw.latitude === 'number' ? raw.latitude : 28.6139,
    longitude: typeof raw.longitude === 'number' ? raw.longitude : 77.2090,
    elevation: typeof raw.altitude === 'number' ? raw.altitude : (raw.elevation || 216),
    status,
